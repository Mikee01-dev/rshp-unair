            ...
            <div class="col-md-6">
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body text-center bg-info text-white rounded-top">
                        ...
                        <small class="opacity-75">Perawat Hewan</small>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between">
                                ...
                                <span>{{ $perawat->no_hp ?? '-' }}</span>
                            </li>

                            <li class="list-group-item d-flex justify-content-between">
                                <strong>Jenis Kelamin</strong>
                                <span>{{ $perawat->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}</span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between">
                                ...
                                <span class="text-end" style="max-width: 60%;">{{ $perawat->alamat ?? '-' }}</span>
                            </li>
